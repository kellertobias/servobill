import { type AbstractSettingsEntity, SettingsEntity } from '@/backend/entities/settings.entity';
  ...
  implements SettingsRepository
{
   ...
   */
  protected ormToDomainEntitySafe(entity: Omit<SettingsOrmEntity, 'storeId'>): SettingsEntity {
   ...
   */
  public domainToOrmEntity(domainEntity: SettingsEntity): Omit<SettingsOrmEntity, 'storeId'> {
    return {
