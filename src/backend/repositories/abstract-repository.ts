...
> {
  ...
  protected abstract generateEmptyItem(id: string, ...args: CreateArgs): DomainEntity;

  protected abstract ormToDomainEntitySafe(ormEntity: Omit<OrmEntity, 'storeId'>): DomainEntity;

  protected abstract domainToOrmEntity(domainEntity: DomainEntity): Omit<OrmEntity, 'storeId'>;
  ...
  public abstract createWithId(entityId: string, ...args: CreateArgs): Promise<DomainEntity>;
