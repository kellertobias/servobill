...
export type AttachmentSchemaResponseItem = ResponseItem<string, string, string, AttachmentSchema>;
export type AttachmentOrmEntity = typeof entitySchema.responseItem;

export type AttachmentExpenseLinkSchema = typeof attachmentExpenseLinkSchema.schema;
...
>;
export type AttachmentExpenseLinkOrmEntity = typeof attachmentExpenseLinkSchema.responseItem;
