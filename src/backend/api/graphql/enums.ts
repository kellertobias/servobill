...
import { InvoiceOutputFormat, VatStatus } from '@/backend/entities/settings.entity';
...
registerEnumType(VatStatus, {
  name: 'VatStatus',
  description: 'VAT/tax status of the company (affects invoice tax display and legal compliance)',
});
