...
export class CompanyDataSetting extends AbstractSettingsEntity {
  ...
  constructor(
    ...
    if (params.vatStatus && Object.values(VatStatus).includes(params.vatStatus)) {
...
export class InvoiceSettingsEntity extends AbstractSettingsEntity {
  ...
  constructor(
    ...
    super(params, saveInner);
    this.invoiceNumbers = new IncrementNumberBehavior(params.invoiceNumbers || {}, this);
    this.offerNumbers = new IncrementNumberBehavior(params.offerNumbers || {}, this);
    this.customerNumbers = new IncrementNumberBehavior(params.customerNumbers || {}, this);
    ...
    if (typeof params.invoiceOutputFormat === 'string') {
      this.invoiceOutputFormat =
        InvoiceOutputFormat[params.invoiceOutputFormat as keyof typeof InvoiceOutputFormat] ||
