...
export class ZugferdInvoiceGenerator extends InvoiceGeneratorStrategy {
  ...
  async generate(
    ...
    const profileData: ProfileBasic = mapInvoiceToProfileBasic(invoice, options.companyData);
    ...
    const pdfUint8 = new Uint8Array(pdfBuffer.buffer, pdfBuffer.byteOffset, pdfBuffer.byteLength);
