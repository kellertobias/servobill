...
import { Entity, type ResponseItem, type Schema } from 'electrodb';
import { Inject, Service } from '@/common/di';
import type { ConfigService } from './config.service';
import { DatabaseType } from './constants';
import { CONFIG_SERVICE, DYNAMODB_SERVICE, DYNAMODB_TEST_SET } from './di-tokens';
...
export class DynamoDBService {
  ...
  public getEntity<A extends string, F extends string, C extends string, S extends Schema<A, F, C>>(
    schema: S
  ): Entity<A, F, C, S> {
