...
describe('LLMService', () => {
  ...
  describe('OpenAI provider', () => {
    it('should send a request and return a response', async () => {
      ...
      const service = new LLMService(new MockConfigService(config) as unknown as ConfigService);
  ...
  describe('constructor', () => {
    it('should throw if configService.llm is missing', () => {
      ...
      expect(() => new LLMService(new BadConfigService() as unknown as ConfigService)).toThrow(
