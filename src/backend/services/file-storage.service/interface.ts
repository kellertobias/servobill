...
export interface FileStorageService {
   ...
   */
  saveFile(key: string, file: Buffer, options?: { bucket?: string }): Promise<string>;
   ...
   */
  getDownloadUrl(attachment: AttachmentEntity | { bucket?: string; key: string }): Promise<string>;
