...
describe('S3Service', () => {
  ...
  beforeEach(() => {
    ...
    (S3Client as unknown as MockInstance).mockImplementation(() => s3ClientInstance);
  ...
  it('getSignedUploadUrl returns a signed URL', async () => {
    (getSignedUrl as unknown as MockInstance).mockResolvedValue('https://signed-upload-url');
    (PutObjectCommand as unknown as MockInstance).mockImplementation((input: unknown) => input);
  ...
  it('getSignedUrl returns a signed download URL', async () => {
    (getSignedUrl as unknown as MockInstance).mockResolvedValue('https://signed-download-url');
    (GetObjectCommand as unknown as MockInstance).mockImplementation((input: unknown) => input);
  ...
  it('deleteObject calls S3 client with DeleteObjectCommand', async () => {
    (DeleteObjectCommand as unknown as MockInstance).mockImplementation((input: unknown) => input);
