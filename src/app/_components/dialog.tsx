			...
			>
				...
				<div className="fixed inset-0 z-10 w-screen overflow-y-auto">
					<div className="flex min-h-full items-end justify-center p-4 text-center sm:items-center sm:p-0 w-full">
						...
						>
							<HeadlessDialog.Panel className="relative transform overflow-hidden rounded-lg bg-white text-left shadow-xl transition-all sm:my-8 w-full sm:max-w-lg">
										...
										<div
											className={clsx(
												'mx-auto flex h-12 w-12 flex-shrink-0 items-center justify-center rounded-full sm:mx-0 sm:h-10 sm:w-10',
												{
													...
													'bg-blue-100':
														!props.options.danger && !props.options.success,
												},
											)}
										>
											<Icon
...
export const confirmDialog = (options: DialogProps) =>
	confirmDialogInner({ options } as unknown as Parameters<
		typeof confirmDialogInner
	>[0]);
