...
export const AnimatedLoadingIcon: React.FC<{ className?: string }> = ({ className }) => (
  <svg
    aria-hidden="true"
    role="status"
  ...
  return (
    <Element
      ...
      className={clsx(
        ...
        {
          'bg-gray-800 text-white hover:bg-gray-700 focus:ring-gray-500': primary,
          'bg-transparent text-gray-800 hover:bg-gray-200 focus:ring-gray-500': link,
          ...
          'bg-white text-gray-800 hover:bg-gray-200 focus:ring-gray-900 ring-1 ring-gray-300/70':
            secondary,
          'bg-rose-600 text-white hover:bg-rose-700 focus:ring-rose-500': danger,
          'bg-green-600 text-white hover:bg-green-700 focus:ring-green-500': success,
