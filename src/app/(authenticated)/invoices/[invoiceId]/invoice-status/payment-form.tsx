...
export const onClickEnterPayment = async (props: { data: InvoiceData; reload: () => void }) => {
  const payment = {
    current: {
  ...
  if (
    await confirmDialog({
      ...
      content: (
        <>
          <p className="mb-3">
            This will send the invoice to the customer and mark it as sent. This action cannot be
            undone.
          </p>
          <InvoicePaymentForm
