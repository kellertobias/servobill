...
const getActivityIcon = (type: InvoiceActivityType) => {
  switch (type) {
    case InvoiceActivityType.Imported: {
      return <PlusCircleIcon className="h-6 w-6 text-gray-600" aria-hidden="true" />;
    }
    ...
    case InvoiceActivityType.SentOfferLetter: {
      return <EnvelopeIcon className="h-4 w-4 text-gray-400" aria-hidden="true" />;
    }
    case InvoiceActivityType.SentInvoiceManually:
    case InvoiceActivityType.SentOfferManually: {
      return <EnvelopeIcon className="h-4 w-4 text-blue-600" aria-hidden="true" />;
    }
    ...
    case InvoiceActivityType.EmailSent: {
      return <EnvelopeIcon className="h-4 w-4 text-green-600" aria-hidden="true" />;
    }
    case InvoiceActivityType.EmailDelivered: {
      return <EnvelopeIcon className="h-4 w-4 text-green-600" aria-hidden="true" />;
    }
    case InvoiceActivityType.EmailBounced: {
      return <EnvelopeIcon className="h-4 w-4 text-red-600" aria-hidden="true" />;
    }
    case InvoiceActivityType.Payment: {
      return <CheckCircleIcon className="h-6 w-6 text-blue-600" aria-hidden="true" />;
    }
    ...
    case InvoiceActivityType.Attachment: {
      return <PaperClipIcon className="h-4 w-4 text-gray-400" aria-hidden="true" />;
    }
    default: {
...
const getActivityText = (
  ...
  attachment: NonNullable<ReturnType<typeof useInvoiceActivity>['data']>[number]['attachment'],
  actions?: {
  ...
  switch (type) {
    case InvoiceActivityType.Imported: {
      return (
        <>
          <span className="font-medium text-gray-900">{user}</span> imported the invoice.
        </>
      );
    }
    case InvoiceActivityType.CreatedInvoice: {
      return (
        <>
          <span className="font-medium text-gray-900">{user}</span> created the invoice.
        </>
      );
    }
    ...
    case InvoiceActivityType.CreatedOffer: {
      return (
        <>
          <span className="font-medium text-gray-900">{user}</span> created the offer.
        </>
      );
    }
    ...
    case InvoiceActivityType.ConvertToInvoice: {
      return (
        <>
          <span className="font-medium text-gray-900">{user}</span> converted the offer to an
          invoice.
        </>
      );
    }
    ...
    case InvoiceActivityType.SentInvoiceEmail: {
      return (
        <>
          <span className="font-medium text-gray-900">{user}</span> triggered the invoice to be sent
    ...
    case InvoiceActivityType.SentOfferEmail: {
      return (
        <>
          <span className="font-medium text-gray-900">{user}</span> triggered the offer to be sent
          via email to the client.
        </>
      );
    }
    ...
    case InvoiceActivityType.SentInvoiceManually: {
      return (
        <>
          <span className="font-medium text-gray-900">{user}</span> marked the invoice to be sent
    ...
    case InvoiceActivityType.SentOfferManually: {
      return (
        <>
          <span className="font-medium text-gray-900">{user}</span> marked the offer to be sent
          manually to the client.
        </>
      );
    }
    ...
    case InvoiceActivityType.CancelledScheduledSend: {
      return (
        <>
          <span style={{ textDecoration: 'line-through' }}>{notes}</span> The scheduled send was
          cancelled.
        </>
      );
    }
    ...
    case InvoiceActivityType.CancelOffer: {
      return (
        <>
          <span className="font-medium text-gray-900">{user}</span> cancelled the invoice.
        </>
      );
    }
    ...
    case InvoiceActivityType.ArchiveOffer: {
      return (
        <>
          <span className="font-medium text-gray-900">{user}</span> archived the invoice.
        </>
      );
    }
    ...
    case InvoiceActivityType.Payment: {
      return (
        <>
          <span className="font-medium text-gray-900">{user}</span> added a payment of {notes} to
          the invoice.
        </>
      );
    }
    ...
    case InvoiceActivityType.Paid: {
      return (
        <>
          <span className="font-medium text-gray-900">{user}</span> marked the invoice as fully
          paid.
        </>
      );
    }
    ...
    case InvoiceActivityType.Updated: {
      return (
        <>
          <span className="font-medium text-gray-900">{user}</span> updated the invoice.
        </>
      );
    }
    case InvoiceActivityType.Attachment: {
      return (
        <>
          <span className="font-medium text-gray-900">{user}</span> added {attachment?.fileName}
        </>
      );
    }
  }
...
export function InvoiceActivityFeed() {
  ...
  const { data, reload, toggleAttachToEmail, deleteAttachmentActivity, cancelScheduledSend } =
    useInvoiceActivity();
                ...
                {activity.type === InvoiceActivityType.Note ? (
                  <>
                    ...
                    <div className="flex-auto rounded-md p-2 -m-2 my-1.5 ring-1 ring-inset ring-gray-200">
                      ...
                      <p className="text-sm leading-6 text-gray-500">{activity.notes}</p>
                    </div>
                  </>
                    ...
                    <div className="flex-auto">
                      ...
                      <div className="flex items-center gap-2 mt-1">
                        ...
                        <label className="flex items-center gap-2 text-xs">
                          ...
                          />
                          <span className="text-xs text-gray-500">Attach to emails</span>
                        </label>
                      </div>
                    </div>
