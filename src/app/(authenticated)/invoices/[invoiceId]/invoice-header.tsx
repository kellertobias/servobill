...
import { InlineEditableArea, InlineEditableDate, InlineEditableText } from './helpers';
    ...
    <>
      ...
      <dl className="mt-6 grid grid-cols-1 text-sm leading-6 sm:grid-cols-2">
        <div className="mt-8 sm:mt-6 sm:border-t sm:border-gray-900/5 sm:pt-6">
          <InlineEditableArea locked={locked} onStartEditing={() => showCustomerModal()}>
            {() => (
              <>
                ...
                <dd className="mt-2 text-gray-500">
                  ...
                  <br />
                  {data.customer.countryCode}-{data.customer?.zip} {data.customer?.city},{' '}
                  {data.customer?.state}
                </dd>
              </>
            )}
