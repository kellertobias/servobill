 ...
 */
export const InventoryItemStatusCard: React.FC<InventoryItemStatusCardProps> = ({
  status,
  onStatusChange,
  nextCheck,
  lastScanned,
  ...
  return (
    <div className="">
      <h2 className="text-base font-semibold leading-6 text-gray-900 mb-2">Status</h2>
      ...
      <div className="space-y-3">
        ...
        <div>
          <div className="font-semibold text-gray-800 text-xs">Last Scanned</div>
          <div className="text-gray-700 text-sm">
