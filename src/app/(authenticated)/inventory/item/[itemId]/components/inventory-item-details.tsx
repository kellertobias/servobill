    ...
    <div className="px-4 py-8 sm:mx-0 sm:px-8 sm:pb-14 xl:px-16 xl:pb-20 xl:pt-16 shadow-sm ring-1 ring-gray-900/5 rounded-lg bg-white">
      <div className="space-y-4">
        ...
        <div>
          ...
          <label className="block text-sm font-bold leading-6 text-gray-900 mb-1">Item Name</label>
          <InlineEditableText
            value={details.name}
        ...
        <div>
          {/* Note: Label is not programmatically associated due to InlineEditableText limitations. */}
          <label className="block text-sm  font-bold leading-6 text-gray-900 mb-1">Barcode</label>
          <InlineEditableText
        ...
        <div>
          <label className="block text-sm font-bold leading-6 text-gray-900 mb-1">Type</label>
          {editingType ? (
            <InventoryTypeSelect
              value={details.type}
            ...
            <div className="flex items-center gap-2">
              <span className="text-gray-900">
                ...
                {details.typeName || <span className="text-gray-400">No type</span>}
              </span>
              <button
                type="button"
        ...
        <InventoryItemProperties
          ...
          setProperties={(props) => setDetails((d) => ({ ...d, properties: props }))}
          setDetailsChanged={setDetailsChanged}
        />
        <div className="pt-4 flex justify-end">
          <Button className="mt-4" primary disabled={!detailsChanged} onClick={onSave}>
            Save Details
          </Button>
        </div>
      </div>
