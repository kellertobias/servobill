...
import { InventoryCheckState, InventoryHistoryType } from '@/common/gql/graphql';
...
const getHistoryIcon = (type: InventoryHistoryType, state?: InventoryCheckState | null) => {
  switch (type) {
...
const getHistoryText = (entry: InventoryActivityFeedProps['history'][number]) => {
  switch (entry.type) {
    case InventoryHistoryType.Note: {
      return 'Note added';
    }
...
export const InventoryActivityFeed: React.FC<InventoryActivityFeedProps> = ({
  ...
  return (
    <div className="mx-4">
      <h2 className="text-base font-semibold leading-6 text-gray-900 mb-2">Activity & History</h2>
