...
import { exportCustomers, importCustomers } from '@/api/import-export/customers';
  ...
  return (
    <>
      ...
      <PageContent
        ...
        right={
          <>
            <Button icon={PlusIcon} header onClick={() => setSelectedCustomerId('new')}>
              New Customer
            </Button>
          </>
        }
              ...
              render: (customer) => (
                <>
                  ...
                  <div className="mt-1 text-xs leading-5 text-gray-500">
                    <span className="text-gray-900">{customer.contactName}</span>
                  </div>
                </>
              ),
            },
            ...
            },
            {
              ...
              render: (customer) => (
                <>
                  ...
                  <div className="mt-1 text-xs leading-5 text-gray-500">
                    <span className="text-gray-900">{customer.customerNumber}</span>
                  </div>
                </>
              ),
            },
