 ...
 */
export default function AIExtractionModal({ isOpen, onClose }: AIExtractionModalProps) {
                    ...
                    <div className="mt-3 text-center sm:ml-4 sm:mt-0 sm:text-left w-full">
                      ...
                      <div className="mt-2">
                        <p className="text-sm text-gray-500 mb-4">
                          Upload one or more receipts or invoices to automatically extract expense
                          information using AI. The extraction process may take some time, and you
                          will receive a summary of the extracted expenses by email once the process
                          is complete.
                        </p>
