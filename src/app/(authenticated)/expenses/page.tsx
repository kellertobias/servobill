...
export default function ExpensesHomePage() {
  const [selectedExpenseId, setSelectedExpenseId] = React.useState<null | string>(null);
  const [isAIExtractionModalOpen, setIsAIExtractionModalOpen] = React.useState(false);
      ...
      <PageContent
        ...
        right={
          <>
            ...
            <Button icon={PlusIcon} header grouped onClick={() => setSelectedExpenseId('new')}>
              New Expense
            </Button>
          </>
        }
        ...
        <Table
          ...
          columns={[
                ...
                <>
                  {expense.category ? (
                    <span
                      ...
                      title={expense.category.description || expense.category.name}
                    >
                      <svg
                        viewBox="0 0 6 6"
                        aria-hidden="true"
            ...
            },
            {
              ...
              render: (expense) => (
                <>
                  <div className="text-sm font-medium leading-6 text-gray-900">{expense.name}</div>
