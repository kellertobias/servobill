            ...
            <div className="space-y-6 pb-5 pt-6">
                      ...
                      setData((current) => {
                        ...
                        if (!taxManuallyChanged) {
                          taxAmount = API.centsToPrice(
                            Math.round((API.priceToCents(expenditure) / 119) * 19)
                          );
                        }
              ...
              <div>
                <Input
                  ...
                  onChange={(expendedAt) => setData((current) => ({ ...current, expendedAt }))}
                />
              </div>
                ...
                <div>
                  <div className="w-full">
                    ...
                    <p className="text-xs text-gray-500 mt-2">
                      No expense categories found. You can create categories in the{' '}
                      <Link
              ...
              <div>
                <Input
                  ...
                  onChange={(description) => setData((current) => ({ ...current, description }))}
                  textarea
                />
              </div>
              <div>
              ...
              <div>
                <AttachmentDropzone
                  ...
                  onChange={(attachments) => setData((current) => ({ ...current, attachments }))}
